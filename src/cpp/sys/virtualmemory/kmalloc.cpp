...
static unsigned int l_pageSize = PAGE_FRAME_SIZE; ///< The size of an individual page. Set up in
                                                  ///< liballoc_init.
...
#ifdef DEBUG
    kdebug("liballoc: {} PREFIX(malloc)( {} ): ", __builtin_return_address(0), size);
    ;
#endif
...
#ifdef DEBUG
    kdebug("liballoc: {} PREFIX(free)( {} ): ", __builtin_return_address(0), ptr);
    ;
#endif
