...
{
	const struct fdt_node_header *nh = reinterpret_cast<const struct fdt_node_header*>(fdt_offset_ptr_(fdt, nodeoffset));
	const char *nameptr;
	int err;
