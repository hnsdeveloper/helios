...
#ifndef __ASSEMBLY__
unsigned long bootelf_exec(unsigned long (*entry)(int, char *const[]), int argc, char *const argv[]);
unsigned long bootelf(unsigned long addr, Bootelf_flags flags, int argc, char *const argv[]);
